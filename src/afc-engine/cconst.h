...
class CConst
{
    public:
        ...
        /**** AntennaType ****/
        /**************************************************************************************/
        enum AntennaTypeEnum { antennaOmni, antennaLUT_H, antennaLUT_V, antennaLUT_Boresight, antennaLUT };
        /**************************************************************************************/
        ...
        /**** SimulationEnum ****/
        /**************************************************************************************/
        enum SimulationEnum { FixedSimulation, MobileSimulation, RLANSensingSimulation, showFSPwrAtRLANSimulation, FSToFSSimulation };
        /**************************************************************************************/

        /**************************************************************************************/
        /**** LengthUnit ****/
        /**************************************************************************************/
        enum LengthUnitEnum { mmLengthUnit, cmLengthUnit, mLengthUnit, KmLengthUnit, milLengthUnit, inLengthUnit, ftLengthUnit };
        /**************************************************************************************/
        ...
        /**** HeightSource ****/
        /**************************************************************************************/
        enum HeightSourceEnum { unknownHeightSource, globalHeightSource, depHeightSource, srtmHeightSource, cdsmHeightSource, lidarHeightSource };
        /**************************************************************************************/
        ...
        /**************************************************************************************/
        enum Winner2UnknownLOSMethodEnum { PLOSCombineWinner2UnknownLOSMethod, PLOSThresholdWinner2UnknownLOSMethod };
        /**************************************************************************************/
        ...
        /**** ITMClutterMethod ****/
        /**************************************************************************************/
        enum ITMClutterMethodEnum { ForceTrueITMClutterMethod, ForceFalseITMClutterMethod, BldgDataITMCLutterMethod };
        /**************************************************************************************/
        ...
        /**************************************************************************************/
        enum ScanPointBelowGroundMethodEnum { DiscardScanPointBelowGroundMethod, TruncateScanPointBelowGroundMethod };
        /**************************************************************************************/
        ...
        /**** AntennaCategory ****/
        /**************************************************************************************/
        enum AntennaCategoryEnum { HPAntennaCategory, B1AntennaCategory, OtherAntennaCategory, UnknownAntennaCategory };
        /**************************************************************************************/
