...
double ULSClass::getStartAllocFreq() {return(startAllocFreq); }
double ULSClass::getStopAllocFreq() {return(stopAllocFreq); }
...
std::string ULSClass::getRxCallsign() {return(rxCallsign); }
int ULSClass::getRxAntennaNumber() {return(rxAntennaNumber); }
double ULSClass::getRxLongitudeDeg() {return(rxLongitudeDeg); }
double ULSClass::getRxLatitudeDeg() {return(rxLatitudeDeg); }
double ULSClass::getRxGroundElevation()      { return(rxGroundElevation); }
double                   ULSClass::getRxTerrainHeight()       { return(rxTerrainHeight); }
double                   ULSClass::getRxHeightAboveTerrain()  { return(rxHeightAboveTerrain); }
double                   ULSClass::getRxHeightAMSL()          { return(rxHeightAMSL); }
CConst::HeightSourceEnum ULSClass::getRxHeightSource()        { return(rxHeightSource); }
double ULSClass::getTxLongitudeDeg() {return(txLongitudeDeg); }
double ULSClass::getTxLatitudeDeg() {return(txLatitudeDeg); }
std::string ULSClass::getTxPolarization()      { return(txPolarization); }
double ULSClass::getTxGroundElevation()      { return(txGroundElevation); }
double                   ULSClass::getTxTerrainHeight()       { return(txTerrainHeight); }
...
double ULSClass::getFadeMarginDB() { return(fadeMarginDB); }
std::string ULSClass::getStatus() { return(status); }
CConst::ULSAntennaTypeEnum ULSClass::getRxAntennaType() { return(rxAntennaType); }
CConst::ULSAntennaTypeEnum ULSClass::getTxAntennaType() { return(txAntennaType); }
AntennaClass *ULSClass::getRxAntenna() { return(rxAntenna); }
AntennaClass *ULSClass::getTxAntenna() { return(txAntenna); }
double ULSClass::getTxGain()        { return(txGain); }
double ULSClass::getTxEIRP()        { return(txEIRP); }
double ULSClass::getLinkDistance()  { return(linkDistance); }
double ULSClass::getOperatingRadius()  { return(operatingRadius); }
double ULSClass::getRxSensitivity()  { return(rxSensitivity); }
double ULSClass::getOperatingCenterLongitudeDeg() { return(operatingCenterLongitudeDeg); }
double ULSClass::getOperatingCenterLatitudeDeg() { return(operatingCenterLatitudeDeg); }
double ULSClass::getPropLoss() { return(propLoss); }
...
void ULSClass::setStopAllocFreq(double f) { stopAllocFreq = f; return; }
...
void ULSClass::setRxCallsign(std::string rxCallsignVal) { rxCallsign = rxCallsignVal; return; }
void ULSClass::setRxAntennaNumber(int rxAntennaNumberVal) { rxAntennaNumber = rxAntennaNumberVal; return; }
void ULSClass::setRxLatitudeDeg(double rxLatitudeDegVal) { rxLatitudeDeg = rxLatitudeDegVal; return; }
void ULSClass::setRxLongitudeDeg(double rxLongitudeDegVal) { rxLongitudeDeg = rxLongitudeDegVal; return; }
void ULSClass::setRxGroundElevation(double rxGroundElevationVal) { rxGroundElevation = rxGroundElevationVal; return; }
void ULSClass::setRxTerrainHeight(double rxTerrainHeightVal) { rxTerrainHeight = rxTerrainHeightVal; return; }
void ULSClass::setRxHeightAboveTerrain(double rxHeightAboveTerrainVal) { rxHeightAboveTerrain = rxHeightAboveTerrainVal; return; }
void ULSClass::setRxHeightAMSL(double rxHeightAMSLVal) { rxHeightAMSL = rxHeightAMSLVal; return; }
void ULSClass::setRxHeightSource(CConst::HeightSourceEnum rxHeightSourceVal) { rxHeightSource = rxHeightSourceVal; return; }
void ULSClass::setTxLatitudeDeg(double txLatitudeDegVal) { txLatitudeDeg = txLatitudeDegVal; return; }
void ULSClass::setTxLongitudeDeg(double txLongitudeDegVal) { txLongitudeDeg = txLongitudeDegVal; return; }
void ULSClass::setTxPolarization(std::string txPolarizationVal) { txPolarization = txPolarizationVal;  return; }
void ULSClass::setTxGroundElevation(double txGroundElevationVal) { txGroundElevation = txGroundElevationVal;  return; }
void ULSClass::setTxTerrainHeight(double txTerrainHeightVal) { txTerrainHeight = txTerrainHeightVal; return; }
...
void ULSClass::setFadeMarginDB(double fadeMarginDBVal) { fadeMarginDB = fadeMarginDBVal; return; }
void ULSClass::setStatus(std::string statusVal) { status = statusVal; return; }
void ULSClass::setRxAntennaType(CConst::ULSAntennaTypeEnum rxAntennaTypeVal) { rxAntennaType = rxAntennaTypeVal;  return; }
void ULSClass::setTxAntennaType(CConst::ULSAntennaTypeEnum txAntennaTypeVal) { txAntennaType = txAntennaTypeVal;  return; }
void ULSClass::setRxAntenna(AntennaClass *rxAntennaVal) { rxAntenna = rxAntennaVal;  return; }
void ULSClass::setTxAntenna(AntennaClass *txAntennaVal) { txAntenna = txAntennaVal;  return; }
void ULSClass::setTxGain(double txGainVal) { txGain = txGainVal;  return; }
void ULSClass::setTxEIRP(double txEIRPVal) { txEIRP = txEIRPVal;  return; }
void ULSClass::setLinkDistance(double linkDistanceVal) { linkDistance = linkDistanceVal;  return; }
void ULSClass::setOperatingRadius(double operatingRadiusVal) { operatingRadius = operatingRadiusVal;  return; }
void ULSClass::setRxSensitivity(double rxSensitivityVal) { rxSensitivity = rxSensitivityVal;  return; }
void ULSClass::setMobileUnit(int mobileUnitVal) { mobileUnit = mobileUnitVal;  return; }
void ULSClass::setOperatingCenterLongitudeDeg(double operatingCenterLongitudeDegVal) { operatingCenterLongitudeDeg = operatingCenterLongitudeDegVal; return; }
void ULSClass::setOperatingCenterLatitudeDeg(double operatingCenterLatitudeDegVal) { operatingCenterLatitudeDeg = operatingCenterLatitudeDegVal; return; }
void ULSClass::setPropLoss(double propLossVal) { propLoss = propLossVal; return; }
