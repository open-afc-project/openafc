...
const StrTypeClass MultibandRasterClass::strHeightResultList[] = {
	...
	{MultibandRasterClass::NO_DATA, "NO_DATA"}, {MultibandRasterClass::NO_BUILDING, "NO_BUILDING"},
...
MultibandRasterClass::MultibandRasterClass(
	const std::string &rasterFile, CConst::LidarFormatEnum formatVal) :
...
void MultibandRasterClass::getHeight(const double &latDeg, const double &lonDeg,
	double &terrainHeight, double &bldgHeight, HeightResult &heightResult,
	bool directGdalMode) const
{
