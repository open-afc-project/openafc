...
class MultiGeometryIterable
{
    public:
         ...
         */
        MultiGeometryIterable(Container &geom) : _geom(&geom)
        {
        }
        ...
        class base_iterator
        {
            public:
                 ...
                 */
                base_iterator(Container &geom, int index) : _geom(&geom), _ix(index)
                {
                }
...
class MultiGeometryIterableConst : public MultiGeometryIterable<const MemberGeom, const OGRGeometryCollection>
{
    public:
        MultiGeometryIterableConst(const OGRGeometryCollection &geom) : MultiGeometryIterable<const MemberGeom, const OGRGeometryCollection>(geom)
        {
        }
};

template<class MemberGeom>
class MultiGeometryIterableMutable : public MultiGeometryIterable<MemberGeom, OGRGeometryCollection>
{
    public:
        MultiGeometryIterableMutable(OGRGeometryCollection &geom) : MultiGeometryIterable<MemberGeom, OGRGeometryCollection>(geom)
        {
        }
};
