...
void computeElevationVector(const TerrainClass *terrain, bool includeBldg, bool cdsmFlag,
	const QPointF &from, const QPointF &to, int numpts, std::vector<double> &hi,
	std::vector<double> &di, double ae);
