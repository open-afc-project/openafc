        ...
        switch (lineType) {
            ...
            case dataLineType:
                ...
                if (strval.empty()) {
                    ...
                    if (frequency <= 0.0) {
                        errStr << "ERROR: Frequency Assignment file \"" << filename << "\" line " << linenum << " invalid frequency: \"" << strval
                               << "\"" << std::endl;
                        throw std::runtime_error(errStr.str());
                    }
                }
                ...
                if (strval.empty()) {
                    ...
                    if (bandwidth <= 0.0) {
                        errStr << "ERROR: Frequency Assignment file \"" << filename << "\" line " << linenum << " invalid bandwidth: \"" << strval
                               << "\"" << std::endl;
                        throw std::runtime_error(errStr.str());
                    }
                }
