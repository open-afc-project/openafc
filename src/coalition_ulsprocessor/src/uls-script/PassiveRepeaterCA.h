/*
 *      This data structure stores the data related to a Back To Back Passive Repeater Data and
 * Billboard Passive Repeader Data for Canada (CA). There is a field in this for each relevent
 * column in the ISED database, regardless of whether or not it is populated.
 *
 */
