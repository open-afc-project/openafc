/*
 *      Useful constants for various purposes. All static and public so they can be seen from
 * everywhere.
 */
...
const double MathConstants::GeostationaryOrbitRadius =
	MathConstants::EarthMaxRadius +
