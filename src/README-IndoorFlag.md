...
If the ID is already in the database, it gets the refresh time and location value updated.
If the ID is not in the database, it gets added with the location value.
