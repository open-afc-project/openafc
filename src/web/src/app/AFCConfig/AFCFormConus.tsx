 ...
 */
export class AFCFormConus extends React.Component<
    {
        limit: Limit,
...
> {
    ...
    private setMinEIRP = (n: number) => this.setState({ config: Object.assign(this.props.config, { minEIRP: n }) });
    private setMaxEIRP = (n: number) => this.setState({ config: Object.assign(this.props.config, { maxEIRP: n }) });
    private setMinPSD = (n: number) => this.setState({ config: Object.assign(this.props.config, { minPSD: n }) });
    private setFeederLoss = (f: FSReceiverFeederLoss) => this.setState({ config: Object.assign(this.props.config, { receiverFeederLoss: f }) });
    private setReceiverNoise = (f: FSReceiverNoise) => this.setState({ config: Object.assign(this.props.config, { fsReceiverNoise: f }) });
    private setThreshold = (n: number) => this.setState({ config: Object.assign(this.props.config, { threshold: n }) });
    private setMaxLinkDistance = (n: number) => this.setState({ config: Object.assign(this.props.config, { maxLinkDistance: n }) });
     private setEnableMapInVirtualAp = (n: boolean) => this.setState({ config: Object.assign(this.props.config, { enableMapInVirtualAp: n }) });
    private setVisiblityThreshold = (n: number) => this.setState({ config: Object.assign(this.props.config, { visibilityThreshold: n }) });
    ...
    private setNlcdFile = (n: string) => this.setState({ config: Object.assign(this.props.config, { nlcdFile: n }) });
    ...
    render() {
        ...
        const setChannelResponseAlgorithm = (v: ChannelResponseAlgorithm) => {
            this.setState({ config: Object.assign(this.props.config, { channelResponseAlgorithm: v }) });
        }
        ...
        return (
            <>
               <GalleryItem>
                            ...
                            <FormGroup label="FS Receiver Noise Floor" fieldId="horizontal-form-receiver-noise">
                                ...
                                <InputGroup>
                                    ...
                                    <TextInput
                                        ...
                                        onChange={x => this.setReceiverNoise({ ...this.props.config.fsReceiverNoise, IDU: Number(x) })}
                                        type="number"
                                        step="any"
                                ...
                                <InputGroup>
                                    ...
                                    <TextInput
                                        ...
                                        onChange={x => this.setReceiverNoise({ ...this.props.config.fsReceiverNoise, ODU: Number(x) })}
                                        type="number"
                                        step="any"
                        ...
                        <GalleryItem>
                        <AntennaPatternForm
                                data={this.props.antennaPatternData}
                        ...
                        {this.props.config.propagationModel.kind != "FSPL" ?
                            <GalleryItem>
                                <ITMParametersForm data={this.props.config.ITMParameters} onChange={setITMParams} />
                            </GalleryItem>
                            : false}
                        <GalleryItem>
                            <Tooltip
