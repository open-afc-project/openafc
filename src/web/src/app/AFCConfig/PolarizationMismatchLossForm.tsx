 ...
 */
export default class PolarizationMismatchLossForm extends React.PureComponent<{ data: PolarizationLossModel, onChange: (x: PolarizationLossModel) => void }> {
