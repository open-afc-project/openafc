...
> {
  ...
  private getLandCoverOptions = () => {
    const trimmed = this.trimmedRegionStr();
    switch (trimmed) {
      case 'CA':
        return (
          <>
    ...
    <>
      ...
      <GalleryItem>
        <fieldset style={{ border: 'none', padding: 0, margin: 0 }}>
          <legend>FS Receiver Feeder Loss</legend>{' '}
          <Tooltip
      ...
      <GalleryItem>
        <fieldset style={{ border: 'none', padding: 0, margin: 0 }}>
          <legend>FS Receiver Noise Floor</legend>{' '}
          <Tooltip
            position={TooltipPosition.top}
            enableFlip={true}
            className="fs-feeder-loss-tooltip"
      ...
      <GalleryItem>
        <FormGroup fieldId="horizontal-form-channelResponse-pwr" label="Channel Response Algorithm">
          <InputGroup id="">
            <Radio
