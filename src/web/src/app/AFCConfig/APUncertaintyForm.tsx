        ...
        {" "}<Tooltip
                                    ...
                                    content={
                                        <>
                                            ...
                                            <ul>
                                                ...
                                                <li>- The spacing in the Horizonal Plane is specified in points per degree. For example, 3600 points per degree corresponds to 1arcsecond which is 30m at the equator.</li>
            ...
            <InputGroup>
                ...
                <TextInput
                    ...
                    style={{ textAlign: "right" }} /><InputGroupText>ppd</InputGroupText>
            </InputGroup>
            <InputGroup>
                <TextInput
                    id="ap-height-label"
