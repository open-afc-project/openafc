 ...
 */
export class ITMParametersForm extends React.PureComponent<{
  data: ITMParameters;
  ...
  private setGroundType = (s: string) => {
    ...
    this.props.onChange(
      Object.assign(this.props.data, {
        ground: s,
        dielectricConst: constants.dielectricConst,
      ...
      <FormGroup label="ITM Parameters" fieldId="ITM-parameters-form">
        ...
        <Tooltip
          ...
          content={
            <ul>
              <p>
                ITM Path Profile “Min Spacing” and “Max Points” are used to define the points and their uniform spacing
                within the RLAN to FS RX path. The spacing is at the minimum equal to “Min Spacing” (for shorter
                distances) and for larger distances when “Max Points” is reached, it will be larger.
              </p>
              <p>Constraints: </p>
