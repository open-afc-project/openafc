...
export class NewAPDeny extends React.Component<NewAPDenyProps, NewAPDenyState> {
  ...
  private submit() {
    ...
    this.props
      ...
      .then((res) => {
        if (res.kind === 'Success') {
          this.setState((s: NewAPDenyState) => ({
            messageType: 'success',
            messageValue: 'Added Deny AP serial ' + s.serialNumber + ' Cert ID ' + s.certificationId,
          }));
        } else {
    ...
    return (
      <>
        ...
        <Gallery gutter="sm">
          ...
          <GalleryItem>
            <FormGroup label="Serial Number" isRequired={true} fieldId="serial-number-form">
              <TextInput
                type="text"
          ...
          {hasRole('Super') && (
            <GalleryItem>
              <FormGroup label="Org" isRequired={true} fieldId="org-form">
                <TextInput
                  type="text"
                  id="org-form"
                  name="org-form"
