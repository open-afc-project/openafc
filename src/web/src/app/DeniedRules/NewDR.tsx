...
const zoneTypes = ['Circle', 'One Rectangle', 'Two Rectangles', 'Horizon Distance'];
    ...
    if (props.drToEdit !== undefined) {
      ...
      switch (props.drToEdit.zoneType) {
        ...
        case 'Two Rectangles':
          ...
          preState.rect1rightLong = rect2.rectangleOne.rightLong;
          preState.rect2topLat = rect2.rectangleTwo.topLat;
          preState.rect2leftLong = rect2.rectangleTwo.leftLong;
          preState.rect2bottomLat = rect2.rectangleTwo.bottomLat;
    ...
    return (
      <>
        ...
        <Gallery hasGutter>
          ...
          <GalleryItem>
            <FormGroup label="Start Frequency (MHz)" isRequired={true} fieldId="start-freq-form">
              <TextInput
                type="number"
                id="start-freq-form"
          ...
          <GalleryItem>
            ...
            >
              <TextInput
                ...
                validated={!!this.state.endFreq && this.state.endFreq > 0 && (this.state.startFreq ?? 0) <= this.state.endFreq ? 'default' : 'error'}
              />
              <FormHelperText>
                <HelperText>
                  <HelperTextItem variant={!!this.state.endFreq && this.state.endFreq > 0 && (this.state.startFreq ?? 0) <= this.state.endFreq ? 'default' : 'error'}>
          ...
          <GalleryItem>
            <FormGroup label="Exclusion Zone" isRequired={true} fieldId="zone-type-form">
              <FormSelect
                type="number"
                id="zone-type-form"
                name="zone-type-form"
          ...
          {this.state.zoneType == 'Circle' && (
            <>
              <FormGroup fieldId="circle-group">
                ...
                <GalleryItem>
                  <FormGroup label="Circle Center Longitude" isRequired={true} fieldId="circ-long-form">
                    <TextInput
                      type="number"
                      id="circ-long-form"
                      name="circ-long-form"
                ...
                <GalleryItem>
                  <FormGroup label="Circle Radius (km)" isRequired={true} fieldId="circ-radius-form">
                    <TextInput
                      type="number"
                      id="circ-radius-form"
          ...
          {this.state.zoneType == 'One Rectangle' && (
            <>
              <FormGroup fieldId="one-rect-group">
                ...
                <GalleryItem>
                  <FormGroup label="Left Longitude" isRequired={true} fieldId="rect-toplong-form">
                    <TextInput
                      type="number"
                ...
                <GalleryItem>
                  <FormGroup label="Bottom Latitude" isRequired={true} fieldId="rect-botlat-form">
                    <TextInput
                      type="number"
                      id="rect-botlat-form"
                ...
                <GalleryItem>
                  <FormGroup label="Right Longitude" isRequired={true} fieldId="rect-rgtlon-form">
                    <TextInput
                      type="number"
                      id="rect-rgtlon-form"
          ...
          {this.state.zoneType == 'Two Rectangles' && (
            <>
              ...
              <FormGroup label="Rectangle Two" fieldId="rect-two">
                ...
                <GalleryItem>
                  <FormGroup label="Left Longitude" isRequired={true} fieldId="rect2-leftlong-form">
                    <TextInput
                      type="number"
                ...
                <GalleryItem>
                  <FormGroup label="Bottom Latitude" isRequired={true} fieldId="rect2-botlat-form">
                    <TextInput
                      type="number"
                ...
                <GalleryItem>
                  <FormGroup label="Right Longitude" isRequired={true} fieldId="rect2-rgtlon-form">
                    <TextInput
                      type="number"
          ...
          {this.state.zoneType == 'Horizon Distance' && (
            <>
              <FormGroup fieldId="horz-group">
                ...
                <GalleryItem>
                  <FormGroup label="Longitude" isRequired={true} fieldId="circ-long-form">
                    <TextInput
                      type="number"
                      id="circ-long-form"
                      name="circ-long-form"
                ...
                <GalleryItem>
                  <FormGroup label="Antenna AGL height (m)" isRequired={true} fieldId="circ-radius-form">
                    <TextInput
                      type="number"
                      id="circ-radius-form"
                      name="circ-radius-form"
