...
export class FrequencyRangeInput extends React.Component<FrequencyRangeProps, FrequencyRangeState> {
    ...
    private submitBand = () => {
        const isValid = this.state.frequencyRange.name.length > 0 && this.state.frequencyRange.startFreqMHz > 0 && this.state.frequencyRange.stopFreqMHz > this.state.frequencyRange.startFreqMHz 
        if (isValid) {
