...
export class UserAccount extends React.Component<UserAccountProps, UserAccountState> {
  ...
  /** Show Update when local credentials are editable or Admin may change Active. */
  private canSubmitProfile = () => this.state.editCredential || isAdmin();
              ...
              <InputGroup>
                <InputGroupItem isFill>
                  <TextInput
                    ...
                    id="form-email"
                    name="form-email"
                    aria-label="Email (managed by identity provider)"
                  />
                </InputGroupItem>
              </InputGroup>
              <FormHelperText>
                <HelperText>
                  <HelperTextItem>
                    This account uses an external identity provider. Email cannot be changed here.
                  </HelperTextItem>
                </HelperText>
              </FormHelperText>
            </FormGroup>
