...
# Key material must never exist on disk with modes broader than 0600:
# openssl genrsa creates files with umask-default modes, so without this
# the PEM keys are world-readable until the follow-up chmod 600 lands.
umask 077
