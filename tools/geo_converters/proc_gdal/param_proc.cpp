...
/******************************************************************************************/
void ParamProcClass::getParamVal(bool &bvar,
				 ...
				 const std::string &strval)
{
	...
	if (strname != varname) {
		s << "ERROR: Invalid " << filetype << " file \"" << filename << "(" << linenum
		  << ")\"" << std::endl
	...
	if (!fieldVal.empty()) {
		if (fieldVal == "true") {
			...
			s << "ERROR: Invalid " << filetype << " file \"" << filename << "("
			  << linenum << ")\"" << std::endl
			  << "Variable \"" << varname << "\" set to illegal bool value \""
			  << fieldVal << "\"";
			throw std::runtime_error(s.str());
		}
	} else {
...
void ParamProcClass::getParamVal(int &ivar,
				 const std::string &varname,
				 int linenum,
				 const std::string &strname,
				 const std::string &strval)
...
void ParamProcClass::getParamVal(double &dvar,
				 const std::string &varname,
				 int linenum,
				 const std::string &strname,
				 const std::string &strval)
...
void ParamProcClass::getParamVal(char *&svar,
				 const std::string &varname,
				 int linenum,
				 const std::string &strname,
				 const std::string &strval)
...
void ParamProcClass::getParamVal(std::string &svar,
				 const std::string &varname,
				 int linenum,
				 const std::string &strname,
				 const std::string &strval)
...
void ParamProcClass::getParamVal(std::complex<double> &cvar,
				 const std::string &varname,
				 int linenum,
				 const std::string &strname,
				 const std::string &strval)
...
void ParamProcClass::checkStr(const std::string &varname,
			      int idx,
			      int linenum,
			      const std::string &strname)
{
