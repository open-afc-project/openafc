...
void ParameterTemplateClass::readFile(const char *filename)
{
	...
	if (!fp) {
		errStr << "ERROR: Unable to open template file \"" << filename << "\" for reading."
		       << std::endl;
		throw std::runtime_error(errStr.str());
	}
	...
	enum StateEnum { STATE_FORMAT, STATE_READ_VERSION };
			...
			switch (state) {
				case STATE_FORMAT:
					if (strcmp(str1, "FORMAT:") != 0) {
						errStr << "ERROR: Invalid template file \""
						       << filename << "\":" << linenum
						       << " expecting \"FORMAT:\" NOT \"" << str1
						       << "\"" << std::endl;
						throw std::runtime_error(errStr.str());
					} else {
		...
		if (str1 && (str1[0] != '#')) {
			...
			switch (state) {
				case STATE_NUM_PARAM:
					paramProc->getParamVal(numParam,
							       "NUM_PARAM",
							       linenum,
							       str1,
							       str2);
				...
				case STATE_PARAM:
					...
					if ((!found) && (strcmp(paramName, "FUNCTION") == 0)) {
						paramProc->getParamVal(function,
								       "FUNCTION",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "SRC_FILE_3D") == 0)) {
						paramProc->getParamVal(srcFile3D,
								       "SRC_FILE_3D",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "SRC_FILE_2D") == 0)) {
						paramProc->getParamVal(srcFile2D,
								       "SRC_FILE_2D",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "SRC_FILE_RASTER") == 0)) {
						paramProc->getParamVal(srcFileRaster,
								       "SRC_FILE_RASTER",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "SRC_FILE_VECTOR") == 0)) {
						paramProc->getParamVal(srcFileVector,
								       "SRC_FILE_VECTOR",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "SRC_HEIGHT_FIELD_NAME") == 0)) {
						paramProc->getParamVal(srcHeightFieldName,
								       "SRC_HEIGHT_FIELD_NAME",
								       linenum,
								       paramName,
								       paramVal);
						found = true;
					...
					if ((!found) &&
					    (strcmp(paramName, "HEIGHT_FIELD_NAME_3D") == 0)) {
						paramProc->getParamVal(heightFieldName3D,
								       "HEIGHT_FIELD_NAME_3D",
								       linenum,
								       paramName,
								       paramVal);
						found = true;
					...
					if ((!found) &&
					    (strcmp(paramName, "HEIGHT_FIELD_NAME_2D") == 0)) {
						paramProc->getParamVal(heightFieldName2D,
								       "HEIGHT_FIELD_NAME_2D",
								       linenum,
								       paramName,
								       paramVal);
						found = true;
					...
					if ((!found) &&
					    (strcmp(paramName, "OUTPUT_HEIGHT_FIELD_NAME") == 0)) {
						paramProc->getParamVal(outputHeightFieldName,
								       "OUTPUT_HEIGHT_FIELD_NAME",
								       linenum,
								       paramName,
								       paramVal);
						found = true;
					...
					if ((!found) &&
					    (strcmp(paramName, "CMP_FILE_RASTER") == 0)) {
						paramProc->getParamVal(cmpFileRaster,
								       "CMP_FILE_RASTER",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "OUTPUT_FILE") == 0)) {
						paramProc->getParamVal(outputFile,
								       "OUTPUT_FILE",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "OUTPUT_LAYER") == 0)) {
						paramProc->getParamVal(outputLayer,
								       "OUTPUT_LAYER",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "NODATA_VAL") == 0)) {
						paramProc->getParamVal(nodataVal,
								       "NODATA_VAL",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "CLAMP_MIN") == 0)) {
						paramProc->getParamVal(clampMin,
								       "CLAMP_MIN",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "CLAMP_MAX") == 0)) {
						paramProc->getParamVal(clampMax,
								       "CLAMP_MAX",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "TMP_IMAGE_FILE") == 0)) {
						paramProc->getParamVal(tmpImageFile,
								       "TMP_IMAGE_FILE",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "IMAGE_FILE") == 0)) {
						paramProc->getParamVal(imageFile,
								       "IMAGE_FILE",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "IMAGE_FILE_2") == 0)) {
						paramProc->getParamVal(imageFile2,
								       "IMAGE_FILE_2",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "IMAGE_LON_LAT_RES") == 0)) {
						paramProc->getParamVal(imageLonLatRes,
								       "IMAGE_LON_LAT_RES",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "SAMPLES_PER_DEG") == 0)) {
						paramProc->getParamVal(samplesPerDeg,
								       "SAMPLES_PER_DEG",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "POLYGON_EXPANSION") == 0)) {
						paramProc->getParamVal(polygonExpansion,
								       "POLYGON_EXPANSION",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) &&
					    (strcmp(paramName, "POLYGON_SIMPLIFY") == 0)) {
						paramProc->getParamVal(polygonSimplify,
								       "POLYGON_SIMPLIFY",
								       linenum,
								       paramName,
								       paramVal);
					...
					if ((!found) && (strcmp(paramName, "MIN_LON_WRAP") == 0)) {
						paramProc->getParamVal(minLonWrap,
								       "MIN_LON_WRAP",
								       linenum,
								       paramName,
								       paramVal);
				...
				default:
					errStr << "ERROR: Invalid template file \"" << filename
					       << "\":" << linenum << ", invalid state encountered."
					       << std::endl;
					throw std::runtime_error(errStr.str());
					break;
			}
