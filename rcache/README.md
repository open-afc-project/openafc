...
|<small>RCACHE_<br>POSTGRES_<br>PASSWORD_FILE</small>|<small><SECRETS_DIRECTORY>/<br>RCACHE_DB_PASSWORD</small>|docker-compose.yaml,<br>tools/rcache/<br>Dockerfile|rcache,<br>rat_server,<br>msghnd,<br>rcache_tool|File containing password for Rcache DB DSN|
|<small>AFC_DB_<br>CREATOR_URL</small>|<small>http://rat_server/<br>fbrat/admin/CreateDb</small>|docker-compose.yaml|rcache|REST API URL for Postgres database creation|
